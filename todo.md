...
## Phase 16: Date Picker Usability
- [x] Reports: ปรับตัวเลือกวันที่ให้เลือกวันเดียวหรือช่วงวันได้ง่ายและชัดเจนบนแท็บเล็ต
- [x] Reports: เพิ่มปุ่มช่วงเวลายอดนิยมและทางลัดสำหรับการเลื่อนดูวันย้อนหลัง
- [x] ตรวจสอบการแสดงผลบนแท็บเล็ต สร้างหรืออัปเดต test ที่เกี่ยวข้อง และบันทึก checkpoint
- [x] ตรวจสอบ Drawer เลือกวันที่และปุ่มลัดในหน้า Reports ด้วยสิทธิ์ผู้จัดการบน viewport แท็บเล็ต
- [x] บันทึก checkpoint ของ Phase 16 หลังยืนยันการใช้งานจริง
- [x] บันทึก checkpoint ใหม่ของ Phase 16 สำหรับ date picker usability ที่ตรวจสอบแล้ว
